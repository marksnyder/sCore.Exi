namespace SnyderIS.sCore.Exi.Cef
{
    ...
    internal sealed class CoreCefApp : CefApp
    {
        private CefBrowserProcessHandler _browserProcessHandler = new CoreBrowserProcessHandler();
        private CefRenderProcessHandler _renderProcessHandler = new CoreRenderProcessHandler();
